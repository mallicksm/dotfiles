   ...
   opts = {
      ...
      dashboard = {
         ...
         sections = {
            ...
            -- (~/corp/nvim_workspaces.lua returns a list of {key,label,dir}),
            -- so no /project/bugatti paths are hardcoded in portable dotfiles.
            -- Absent on a non-corp box -> pcall falls back to {} and this
            -- section renders nothing. NO fs probe in the generator -- the dir
            -- check lives in dashboard_open_dir() (file-scope, above); a
            -- deleted workspace shows a "[label] not a directory" toast on
