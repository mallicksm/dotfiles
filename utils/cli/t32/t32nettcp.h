...
*/
#define T32_NETTCP_VER_MAJOR(MP_v_) ((((MP_v_))>>24)&0xFF)
#define T32_NETTCP_VER_MINOR(MP_v_) ((((MP_v_))>>12)&0xFFF)
#define T32_NETTCP_VER_PATCH(MP_v_) ((((MP_v_))>> 0)&0xFFF)
